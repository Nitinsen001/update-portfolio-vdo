      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Building smart web and AI solutions for real-world impact
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            From Django web applications to AQI forecasting models, I combine development,
            data engineering, and innovation to create user-first projects that solve
            everyday challenges.
          </p>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            ...
            text="Designing responsive Django and JavaScript-powered interfaces, user journeys, and backend systems for practical applications with clean UX."
          ...
          <TagCard
            number="02"
            title="AI & Predictive Systems"
            text="Implementing Python-based forecasting tools, AQI prediction models, data preprocessing, and automated alert workflows."
          ...
          <TagCard
            ...
            text="Participating in Harvard-affiliated challenges and building concept-to-demo solutions that address social and technical problems."
