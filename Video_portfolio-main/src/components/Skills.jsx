  ...
  const skillsData = [
    {
      ...
      skills: ['Python', 'C', 'C++', 'HTML5', 'CSS3', 'JavaScript', 'Django'],
    },
    {
      category: 'AI & Data',
      skills: ['Machine Learning', 'Pandas', 'NumPy', 'Matplotlib', 'Scikit-learn', 'Streamlit'],
    },
    {
      category: 'Databases & Tools',
      skills: ['Git', 'GitHub', 'VS Code', 'Jupyter Notebook', 'SQLite3', 'MySQL', 'PL/SQL'],
    },
    {
      category: 'Concepts & Development',
      skills: ['OOP', 'Data Structures', 'Algorithms', 'Web Development', 'Responsive Design', 'File Handling'],
    },
  ];
